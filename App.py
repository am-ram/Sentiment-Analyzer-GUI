...
from tkinter import *
# 1.function to print sentiments of the sentence.  
...
# 2.Function for clearing the contents of all entry boxes And text area. 
...
if __name__ == "__main__" : 
    ...
    #the command or function affiliated to that button is executed 
        ...
        negative = Label(gui, text = "Negative Rating is : ", 
                                            bg = "magenta") 

        # Create a neutral : label 
        neutral = Label(gui, text = "Neutral Rating is : ", 
                                        bg = "cyan") 

        # Create a positive : label 
        positive = Label(gui, text = "Positive Rating is :  ", 
                                            bg = "magenta") 

        # Create a overall : label 
        overall = Label(gui, text = "Overall Rating is :  ", 
                                            bg = "cyan") 
